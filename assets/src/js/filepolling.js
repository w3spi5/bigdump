...
(function() {
    ...
    function createFileRow(file, isNew, isUploading) {
        ...
        if (isUploading) {
            ...
            spinnerUse.setAttributeNS('http://www.w3.org/1999/xlink', 'href', 'assets/icons.svg#spinner');
        ...
        if (isUploading) {
            ...
            if (canImport) {
                ...
                var eyeUse = document.createElementNS('http://www.w3.org/2000/svg', 'use');
                eyeUse.setAttributeNS('http://www.w3.org/1999/xlink', 'href', 'assets/icons.svg#eye');
                eyeIcon.appendChild(eyeUse);
